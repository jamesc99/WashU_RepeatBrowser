...
export declare class RowComponentDev extends Component {
     ...
     * ### DO NOT USE!
     */
    $$prop_def: Omit<Partial<svelte.JSX.HTMLAttributes<HTMLTableRowElement>>, 'use' | 'class' | 'rowId'> & Component['$$prop_def'];
}
...
export declare type SMUIDataTableRowAccessor = (SMUIDataTableHeaderRowAccessor | SMUIDataTableBodyRowAccessor) & {
