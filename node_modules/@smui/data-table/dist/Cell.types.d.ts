...
export declare class CellComponentDev extends Component {
     ...
     * ### DO NOT USE!
     */
    $$prop_def: Omit<Partial<svelte.JSX.HTMLAttributes<HTMLTableCellElement>>, 'use' | 'class' | 'numeric' | 'checkbox' | 'columnId' | 'sortable'> & Component['$$prop_def'];
}
...
export declare type SMUIDataTableCellAccessor = (SMUIDataTableHeaderCellAccessor | SMUIDataTableBodyCellAccessor) & {
