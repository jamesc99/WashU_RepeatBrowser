...
onMount(() => {
    instance = new MDCSliderFoundation({
        ...
        getInputValue: (thumb) => { var _a; return `${(_a = (range ? (thumb === Thumb.START ? start : end) : value)) !== null && _a !== void 0 ? _a : 0}`; },
        ...
        isInputFocused: (thumb) => (range && thumb === Thumb.START ? inputStart : input) ===
            document.activeElement,
        getThumbKnobWidth: (thumb) => {
            var _a;
            return ((_a = (range && thumb === Thumb.START ? thumbKnobStart : thumbKnob)) !== null && _a !== void 0 ? _a : thumbKnob).getBoundingClientRect().width;
        },
        getThumbBoundingClientRect: (thumb) => {
            var _a;
            return ((_a = (range && thumb === Thumb.START ? thumbStart : thumbEl)) !== null && _a !== void 0 ? _a : thumbEl).getBoundingClientRect();
        },
        ...
        registerThumbEventHandler: (thumb, evtType, handler) => {
            var _a;
            (_a = (range && thumb === Thumb.START
                ? thumbStart
                : thumbEl)) === null || _a === void 0 ? void 0 : _a.addEventListener(evtType, handler);
        },
        deregisterThumbEventHandler: (thumb, evtType, handler) => {
            var _a;
            (_a = (range && thumb === Thumb.START
                ? thumbStart
                : thumbEl)) === null || _a === void 0 ? void 0 : _a.removeEventListener(evtType, handler);
        },
        registerInputEventHandler: (thumb, evtType, handler) => {
            var _a;
            (_a = (range && thumb === Thumb.START ? inputStart : input)) === null || _a === void 0 ? void 0 : _a.addEventListener(evtType, handler);
        },
        deregisterInputEventHandler: (thumb, evtType, handler) => {
            var _a;
            (_a = (range && thumb === Thumb.START
                ? inputStart
                : input)) === null || _a === void 0 ? void 0 : _a.removeEventListener(evtType, handler);
        },
...
function getInputAttr(name, thumb) {
    ...
    if (range && thumb === Thumb.START) {
        ...
        return name in inputStartAttrs
            ? (_a = inputStartAttrs[name]) !== null && _a !== void 0 ? _a : null
            : (_b = inputStart === null || inputStart === void 0 ? void 0 : inputStart.getAttribute(name)) !== null && _b !== void 0 ? _b : null;
    }
    else {
        if (name === 'value') {
        ...
        return name in inputAttrs
            ? (_c = inputAttrs[name]) !== null && _c !== void 0 ? _c : null
