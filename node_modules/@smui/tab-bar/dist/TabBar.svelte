...
<script>import { MDCTabBarFoundation } from '@material/tab-bar';
...
onMount(() => {
    instance = new MDCTabBarFoundation({
        ...
        activateTabAtIndex: (index, clientRect) => { var _a; return (_a = getAccessor(tabs[index])) === null || _a === void 0 ? void 0 : _a.activate(clientRect, skipFocus); },
        deactivateTabAtIndex: (index) => { var _a; return (_a = getAccessor(tabs[index])) === null || _a === void 0 ? void 0 : _a.deactivate(); },
        focusTabAtIndex: (index) => { var _a; return (_a = getAccessor(tabs[index])) === null || _a === void 0 ? void 0 : _a.focus(); },
        getTabIndicatorClientRectAtIndex: (index) => { var _a, _b; return (_b = (_a = getAccessor(tabs[index])) === null || _a === void 0 ? void 0 : _a.computeIndicatorClientRect()) !== null && _b !== void 0 ? _b : new DOMRect(); },
        ...
        getFocusedTabIndex: () => {
            const tabElements = tabs.map((tab) => { var _a; return (_a = getAccessor(tab)) === null || _a === void 0 ? void 0 : _a.element; });
