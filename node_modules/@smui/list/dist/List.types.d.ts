...
export declare class ListComponentDev<C extends SvelteComponentDev = UlElementComponentDev> extends Component {
    /**
     * @private
     ...
     * ### DO NOT USE!
     */
    $$prop_def: Omit<Partial<svelte.JSX.HTMLAttributes<ReturnType<C['getElement']>>>, 'use' | 'class' | 'nonInteractive' | 'dense' | 'textualList' | 'avatarList' | 'iconList' | 'imageList' | 'thumbnailList' | 'videoList' | 'twoLine' | 'threeLine' | 'vertical' | 'wrapFocus' | 'singleSelection' | 'selectedIndex' | 'radioList' | 'checkList' | 'hasTypeahead' | 'component'> & Component['$$prop_def'];
}
