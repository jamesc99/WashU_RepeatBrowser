...
export declare type Fetcher = (input: RequestInfo, init?: RequestInit) => Promise<PolyfilledResponse>;
/**
...
export interface GenericFilehandle {
    read(buf: Buffer, offset: number, length: number, position: number, opts?: FilehandleOptions): Promise<{
        bytesRead: number;
        buffer: Buffer;
    }>;
