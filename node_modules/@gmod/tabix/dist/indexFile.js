...
var IndexFile = /** @class */ (function () {
    ...
    function IndexFile(_a) {
        var filehandle = _a.filehandle, _b = _a.renameRefSeqs, renameRefSeqs = _b === void 0 ? function (n) { return n; } : _b;
        this.filehandle = filehandle;
        this.renameRefSeq = renameRefSeqs;
    }
    IndexFile.prototype.getMetadata = function (opts) {
        if (opts === void 0) { opts = {}; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), indices = _a.indices, rest = __rest(_a, ["indices"]);
                        return [2 /*return*/, rest];
                }
            });
        });
    };
    IndexFile.prototype._findFirstData = function (currentFdl, virtualOffset) {
        if (currentFdl) {
            ...
            return __generator(this, function (_a) {
                if (!this._parseCache) {
                    this._parseCache = new abortable_promise_cache_1.default({
                        ...
                        fill: function () { return _this._parse(opts); },
                    });
                }
                return [2 /*return*/, this._parseCache.get('index', null, undefined)];
            });
        });
    };
