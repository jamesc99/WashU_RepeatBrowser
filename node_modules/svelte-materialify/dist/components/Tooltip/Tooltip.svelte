...
<style lang="scss" src="./Tooltip.scss" global>:global(.s-tooltip__wrapper){display:inline-block;cursor:pointer}:global(.s-tooltip){background:rgba(97,97,97,.9);color:#fff;border-radius:4px;font-size:14px;line-height:22px;z-index:1000;display:inline-block;padding:5px 16px;position:absolute;text-transform:none;text-align:center;width:auto;opacity:0;pointer-events:none;transform-origin:center;transform:scale(0);transition-property:opacity,transform;transition-duration:.3s,0s;transition-delay:0s,.3s;transition-timing-function:cubic-bezier(0,0,.2,1)}:global(.s-tooltip.active){opacity:.9;transform:scale(1);transition-property:transform,opacity;transition-duration:.3s;transition-delay:0s}</style>
